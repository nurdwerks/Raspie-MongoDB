...
namespace mongo { 
    ...
    namespace dur { 
        ...
        inline packedLE<int>::t& writingInt(packedLE<int>::t& d) { return d; }
        inline storageLE<int>& writingInt( storageLE<int>& d) { return d; }
        ...
        */
        ...
        inline packedLE<int>::t& writingInt(packedLE<int>::t& d) {
            return *((packedLE<int>::t*) writingPtr(&d, sizeof(d)));
        }

        inline storageLE<int>& writingInt( storageLE<int>& d) {
            return *((storageLE<int>*) writingPtr(&d, sizeof(d)));
        }
